...
const SPEED_ROW1 = 62;   // px/sec — bumped up from 45
const SPEED_ROW2 = 52;   // px/sec — bumped up from 35
      ...
      <div style={{display:"flex",flexDirection:"column",gap:Math.floor(rowH*0.04),
        ...
        <div style={{display:"flex",alignItems:"center",gap:9,
          ...
          <div style={{display:"flex",alignItems:"baseline",gap:4,flex:1,minWidth:0}}>
            ...
            {game.away.record&&!game.away.rank&&(
              <span style={{fontSize:Math.floor(rowH*0.065),color:"rgba(255,255,255,0.3)",
                fontWeight:600,marginLeft:2}}>{game.away.record}</span>
            )}
          </div>
          {!isPre&&(
        ...
        <div style={{display:"flex",alignItems:"center",gap:9,
          ...
          <div style={{display:"flex",alignItems:"baseline",gap:4,flex:1,minWidth:0}}>
            ...
            {game.home.record&&!game.home.rank&&(
              <span style={{fontSize:Math.floor(rowH*0.065),color:"rgba(255,255,255,0.3)",
                fontWeight:600,marginLeft:2}}>{game.home.record}</span>
            )}
          </div>
          {!isPre&&(
            <span style={{fontSize:scoreSz,fontWeight:900,lineHeight:1,fontFamily:F,
